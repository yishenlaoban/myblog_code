...
![1555902055367](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852176.png)
...
> 1. 表记录太少
> 2. 经常增删改的表，因为每次更新不单单是更新了记录还会更新索引（速率极低）
> 3. where条件里用不到的字段不创建索引
> 4. 数据列重复的数据太多，没必要建立索引（效果不大）
...
![1555944126588](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852044.png)

2). 插入H，n>4，中间元素G字母向上分裂到新的节点

![1555944549825](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852993.png)

3). 插入E，K，Q不需要分裂

![1555944596893](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852144.png)

4). 插入M，中间元素M字母向上分裂到父节点G

（M 在 K、N中间，BTree最多含有n-1个key，这里即4个key，5个指针）

![1555944652560](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852572.png)

5). 插入F，W，L，T不需要分裂

![1555944686928](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852751.png)

6). 插入Z，中间元素T向上分裂到父节点中

（插入Z后是，NQTWZ，把中间T提出来，方便更快的查询，所以不提出Z）

![1555944713486](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852066.png)

7). 插入D，中间元素D向上分裂到父节点中。然后插入P，R，X，Y不需要分裂

![1555944749984](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852050.png)

8). 最后插入S（R后面），NPQR节点n>5，中间节点Q向上分裂，但分裂后父节点DGMT的n>5，中间节点M向上分裂

![1555944848294](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852929.png)
...
![image-20210520190717898](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852242.png)
...
![1555906287178](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852561.jpeg)
...
![1555906287178](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852063.png)
...
![image-20210520211641159](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852428.png)
...
![image-20210520211835491](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852279.png)

![image-20210520212305695](http://yishenlaoban-img.test.upcdn.net/image_my/202203011852375.png)
...
- 创建
  ...
  ![1551438009843](http://yishenlaoban-img.test.upcdn.net/image_my/202203011853312.png)
