...
![image-20211106144426885](http://yishenlaoban-img.test.upcdn.net/images/image-20211106144426885.png) 
...
![image-20211106154422639](http://yishenlaoban-img.test.upcdn.net/images/image-20211106154422639.png) 
...
![image-20211106154450989](http://yishenlaoban-img.test.upcdn.net/images/image-20211106154450989.png) 
...
![image-20211106155838282](http://yishenlaoban-img.test.upcdn.net/images/image-20211106155838282.png) 
...
![image-20211125085356967](http://yishenlaoban-img.test.upcdn.net/images/image-20211125085356967.png) 
...
![image-20211125093629445](http://yishenlaoban-img.test.upcdn.net/images/image-20211125093629445.png) 

### 5.3 死锁

两个或以上的进程因为争夺资源而造成互相等待资源的现象称为死锁

![image-20211106160337883](http://yishenlaoban-img.test.upcdn.net/images/image-20211106160337883.png) 
...
![image-20211106160432500](http://yishenlaoban-img.test.upcdn.net/images/image-20211106160432500.png) 
...
1. 使用 `jps -l`定位进程号
   ...
   ![image-20211125095410623](http://yishenlaoban-img.test.upcdn.net/images/image-20211125095410623.png)

2. 使用 `jstask 进程号` 查看死锁信息

   ![image-20211125100045698](http://yishenlaoban-img.test.upcdn.net/images/image-20211125100045698.png)
