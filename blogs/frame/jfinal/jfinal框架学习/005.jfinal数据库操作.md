...
![image-20220115202937586](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202937586.png)

###           2.Sql语句拼接

![image-20220115202948706](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202948706.png)

## 3.分页查询Page

###     1.JFinal数据库的分页查询

![image-20220115202959494](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202959494.png)

controller类![image-20220115203009710](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115203009710.png)

###    2.Html实现分页显示

​      ![image-20220115203020680](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115203020680.png)
...
​     1.在ehcache.xml配置缓存
 ...
 ![image-20220115203029808](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115203029808.png)
...
​     如果Cache中有对应的的信息，就从其中拿，没有就从数据库中拿
 ...
 ![image-20220115203043707](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115203043707.png)
...
![image-20220115203058506](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115203058506.png)
...
![image-20220115203114986](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115203114986.png)
