...
![image-20220115201955735](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115201955735.png)
...
![image-20220115202020030](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202020030.png)



直到过期前，这个浏览器访问这个界面都会带上cookie

![image-20220115202029891](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202029891.png)
...
![image-20220115202104765](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202104765.png)

在http 协议中是不支持删除cookie，这里removeCookie, 实际的底层原码是setCookie，只不过是颁发了一个时间为 0 的cookie	

#### 4.Session的使用流程

![image-20220115202117409](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202117409.png)



这里访问http://127.0.0.1:8082/cookies 时颁发Session,同时颁发了cookie,Session放在cookie里

![image-20220115202131440](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202131440.png)
...
![image-20220115202147009](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202147009.png)
...
![image-20220115202201806](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202201806.png)
...
![image-20220115202218580](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202218580.png)

 2、用户中心，

![image-20220115202227557](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202227557.png)



3.login 登陆 这里的/user 是登陆界面

  ![image-20220115202236783](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202236783.png)
...
![image-20220115202253267](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202253267.png)

拦截器如下：

![image-20220115202303541](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202303541.png)

这里退出就是删除 cookie,跳转到/admin页面

![image-20220115202312708](http://yishenlaoban-img.test.upcdn.net/image_my/image-20220115202312708.png)
