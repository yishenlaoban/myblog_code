...
[ 大神文章-Javadoop](https://javadoop.com/post/spring-ioc)
...
<Badge text="spring-context 会自动将 spring-core、spring-beans、spring-aop、spring-expression 这几个基础 jar 包带进来。"/>
...
![image-20220509084939416](https://img.yishenlaoban.top/image_my/image-20220509084939416.png)
...
![image-20220509090321773](https://img.yishenlaoban.top/image_my/image-20220509090321773.png)
...
![image-20220509090341452](https://img.yishenlaoban.top/image_my/image-20220509090341452.png)
...
<Badge text="AbstractXmlApplicationContext.java 80" type="warning"/>
...
<Badge text="AbstractXmlApplicationContext.java 120" type="warning"/>
...
又到初学者科普时间，不熟悉  的读者请看下面贴出来的 xml，这里的第二行 **xmlns** 就是咯。
...
<Badge text=" DefaultBeanDefinitionDocumentReader 298"/>
...
<Badge text="BeanDefinitionParserDelegate 428"/>
...
<Badge text="BeanDefinitionReaderUtils 143" type="warning">
...
<Badge text="DefaultListableBeanFactory 793" type="warning"> 
